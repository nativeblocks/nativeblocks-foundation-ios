...
extension View {
    ...
    internal func blockScaled(_ scale: String) -> some View {
        switch scale {
        case "fill":
...
extension KFImage {
    ...
    internal func blockResizable(_ mode: String) -> KFImage {
...
extension KFImage {
    ...
    internal func blockInterpolation(_ value: String) -> KFImage {
...
extension View {
    ...
    internal func blockAspectRatio(ratio: CGFloat, mode: String) -> some View {
        switch mode {
        case "fill":
            return AnyView(self)
        default:
